...
if __name__ == "__main__":
    ...
    print(str(None))
    # c=createPdf(None, None, None)
    # c.updatePdf("kabhi kabhi mere dil me khayal ata hai","/Users/mohammedk/Downloads/pet_report_8_20231106180907.pdf")
    # # import boto3
    #image = cv2.imread("/Users/mohammedk/Downloads/dog_skin_diseases/Healthy_1.jpg")



    #c = createPdf(image, "bacteria","kabhi kabhi mere dil me khayal ata hai")
    # c.createPDF(s3, s3_access_point= "furscan-hgdzprww3nof8wradxmbi468jiqksuse1a-s3alias")